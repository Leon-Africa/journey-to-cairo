            ...
            <div className="space-y-4">
              { events && events.length> 0 ? (
                events.map((event, index) => (
                  ...
                  <div key={index} className="p4 bg-base-200 rounded-xl">
                    <p className="text-lg">
                      <span className="font-semibold">{event.parsedArgs.account.substring(0, 6)}...{event.parsedArgs.account.slice(-4)}</span>
                      {" "}
                      <span className="font-bold">incremented the counter</span>
                    </p>
                  </div>
                ))
              ) : (
